...
public class TestIssue127 extends TestJythonCallGraphShape {
  ...
  /**
   * Test a combination of {@code __call__}, field access, and keyword arguments on a synthetic
   * object.
   *
   * @see <a href="https://github.com/wala/ML/issues/127">Issue 127</a>
   */
  @Test
  public void testIssue127h()
      throws ClassHierarchyException, IllegalArgumentException, CancelException, IOException {
    PythonAnalysisEngine<?> engine = makeEngine("test_issue127h.py");
    PythonSSAPropagationCallGraphBuilder builder = engine.defaultCallGraphBuilder();
    CallGraph CG = builder.makeCallGraph(builder.getOptions());
   ...
   *
   * <p>This is a control case for comparison with {@link #testIssue127h()}.
   */
  @Test
  public void testIssue127hReal()
      throws ClassHierarchyException, IllegalArgumentException, CancelException, IOException {
    PythonAnalysisEngine<?> engine = makeEngine("test_issue127h_real.py");
    PythonSSAPropagationCallGraphBuilder builder = engine.defaultCallGraphBuilder();
    CallGraph CG = builder.makeCallGraph(builder.getOptions());
