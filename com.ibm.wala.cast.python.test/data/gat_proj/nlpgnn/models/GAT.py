...
class GATLayer(tf.keras.Model):
    def __init__(self, hidden_dim=8, num_class=3, heads=8, dropout_rate=0.4, **kwargs):
        ...
        self.gc1 = GraphAttentionConvolution(
            hidden_dim, heads=heads, concat=True, dropout_rate=dropout_rate, name="gat1"
        )
        self.gc2 = GraphAttentionConvolution(
            num_class, heads=1, concat=True, dropout_rate=dropout_rate, name="gat2"
        )
