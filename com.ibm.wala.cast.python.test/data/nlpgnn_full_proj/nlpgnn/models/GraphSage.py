...
class GraphSAGE(tf.keras.Model):
    ...
    def call(
        self, node_embeddings, edge_indexs, batchs, edge_weights=None, training=True
    ):
        ...
        x = tf.nn.relu(
            self.conv1(GNNInput(node_embeddings, edge_indexs, edge_weights), training)
        )
    ...
    def predict(
        self, node_embeddings, edge_indexs, batchs, edge_weights=None, training=False
    ):
