...
class CrfLogLikelihood(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.transition_params = self.add_weight(
            shape=[num_tags, num_tags], initializer=initializer, name="transitions"
        )
