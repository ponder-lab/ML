...
//    testTf2("tf2_test_tensor_list3.py", "add", 0, 2);
    testTf2("tf2_test_model_call.py", "SequentialModel.__call__", 0, 3); // NOTE: Change to testTf2("tf2_test_model_call.py", "SequentialModel.__call__", 1, 5, 2) once
    // https://github.com/wala/ML/issues/24 is fixed.
    testTf2("tf2_test_model_call2.py", "SequentialModel.call", 0, 3); // NOTE: Change to testTf2("tf2_test_model_call.py", "SequentialModel.call", 1, 5, 2) once
    // https://github.com/wala/ML/issues/24 is fixed.
