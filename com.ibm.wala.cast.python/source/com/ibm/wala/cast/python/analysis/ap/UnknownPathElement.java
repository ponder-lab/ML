...
/**
 * A path element representing an unknown field. Since the field is unknown, this matches anything.
 */
public class UnknownPathElement implements IPathElement {

  private static final UnknownPathElement instance = new UnknownPathElement();
