...
/**
 * Generator for {@code tf.math.asinh}. Pure passthrough — output shape and dtype both inherit from
 * {@code x}.
 *
 * @see <a href="https://www.tensorflow.org/api_docs/python/tf/math/asinh">tf.math.asinh</a>
 * @author <a href="mailto:khatchad@hunter.cuny.edu">Raffi Khatchadourian</a>
 */
public class Asinh extends PassThroughUnaryTensorGenerator {

  /**
   * Parameter positions and keyword names for {@code tf.math.asinh(x, name=None)}. Ordinals match
  ...
  public Asinh(PointsToSetVariable source) {
    super(source);
  }

  public Asinh(CGNode node) {
    super(node);
  }
