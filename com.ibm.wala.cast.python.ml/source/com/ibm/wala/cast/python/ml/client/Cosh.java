...
/**
 * Generator for {@code tf.math.cosh}. Pure passthrough — output shape and dtype both inherit from
 * {@code x}.
 *
 * @see <a href="https://www.tensorflow.org/api_docs/python/tf/math/cosh">tf.math.cosh</a>
 * @author <a href="mailto:khatchad@hunter.cuny.edu">Raffi Khatchadourian</a>
 */
public class Cosh extends PassThroughUnaryTensorGenerator {

  /**
   * Parameter positions and keyword names for {@code tf.math.cosh(x, name=None)}. Ordinals match
  ...
  public Cosh(PointsToSetVariable source) {
    super(source);
  }

  public Cosh(CGNode node) {
    super(node);
  }
