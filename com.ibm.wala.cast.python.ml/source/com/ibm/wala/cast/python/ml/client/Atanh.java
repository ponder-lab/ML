...
/**
 * Generator for {@code tf.math.atanh}. Pure passthrough — output shape and dtype both inherit from
 * {@code x}.
 *
 * @see <a href="https://www.tensorflow.org/api_docs/python/tf/math/atanh">tf.math.atanh</a>
 * @author <a href="mailto:khatchad@hunter.cuny.edu">Raffi Khatchadourian</a>
 */
public class Atanh extends PassThroughUnaryTensorGenerator {

  /**
   * Parameter positions and keyword names for {@code tf.math.atanh(x, name=None)}. Ordinals match
  ...
  public Atanh(PointsToSetVariable source) {
    super(source);
  }

  public Atanh(CGNode node) {
    super(node);
  }
