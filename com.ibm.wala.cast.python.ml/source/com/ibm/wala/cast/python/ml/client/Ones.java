 ...
 * optional-dtype allocator machinery lives in {@link TensorTypeAllocator}; {@code tf.ones} adds no
 * value semantics relevant to tensor-type inference.
 *
 * @see <a href="https://www.tensorflow.org/api_docs/python/tf/ones">TensorFlow ones() API</a>.
 * @author <a href="mailto:khatchad@hunter.cuny.edu">Raffi Khatchadourian</a>
 */
public class Ones extends TensorTypeAllocator {
