...
/**
 * Generator for {@code tf.math.atan}. Pure passthrough — output shape and dtype both inherit from
 * {@code x}.
 *
 * @see <a href="https://www.tensorflow.org/api_docs/python/tf/math/atan">tf.math.atan</a>
 * @author <a href="mailto:khatchad@hunter.cuny.edu">Raffi Khatchadourian</a>
 */
public class Atan extends PassThroughUnaryTensorGenerator {

  /**
   * Parameter positions and keyword names for {@code tf.math.atan(x, name=None)}. Ordinals match
  ...
  public Atan(PointsToSetVariable source) {
    super(source);
  }

  public Atan(CGNode node) {
    super(node);
  }
