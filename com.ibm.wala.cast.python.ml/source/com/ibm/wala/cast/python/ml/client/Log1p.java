...
/**
 * Generator for {@code tf.math.log1p}. Pure passthrough — output shape and dtype both inherit from
 * {@code x}.
 *
 * @see <a href="https://www.tensorflow.org/api_docs/python/tf/math/log1p">tf.math.log1p</a>
 * @author <a href="mailto:khatchad@hunter.cuny.edu">Raffi Khatchadourian</a>
 */
public class Log1p extends PassThroughUnaryTensorGenerator {

  /**
   * Parameter positions and keyword names for {@code tf.math.log1p(x, name=None)}. Ordinals match
  ...
  public Log1p(PointsToSetVariable source) {
    super(source);
  }

  public Log1p(CGNode node) {
    super(node);
  }
