...
/**
 * Generator for {@code tf.math.asin}. Pure passthrough — output shape and dtype both inherit from
 * {@code x}.
 *
 * @see <a href="https://www.tensorflow.org/api_docs/python/tf/math/asin">tf.math.asin</a>
 * @author <a href="mailto:khatchad@hunter.cuny.edu">Raffi Khatchadourian</a>
 */
public class Asin extends PassThroughUnaryTensorGenerator {

  /**
   * Parameter positions and keyword names for {@code tf.math.asin(x, name=None)}. Ordinals match
  ...
  public Asin(PointsToSetVariable source) {
    super(source);
  }

  public Asin(CGNode node) {
    super(node);
  }
